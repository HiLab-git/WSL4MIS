...
class BaseDataSets(Dataset):
    def __init__(self, base_dir=None, num=4, labeled_type="labeled", split='train', transform=None, fold="fold1", sup_type="label",label_ratio=0.1):
        ...
        all_labeled_ids = train_ids[:int(len(train_ids) * self.label_ratio)]
        if self.split == 'train':
    ...
    def _get_fold_ids(self, fold):
        all_cases_set = read_txt('/mnt/sdd/tb/data/MSCMR_v5/train_volumes.list')

        fold1_testing_set = read_txt('/mnt/sdd/tb/data/MSCMR_v5/train_volumes_p1.list')
        fold2_testing_set = read_txt('/mnt/sdd/tb/data/MSCMR_v5/train_volumes_p2.list')
        fold3_testing_set = read_txt('/mnt/sdd/tb/data/MSCMR_v5/train_volumes_p3.list')
        fold4_testing_set = read_txt('/mnt/sdd/tb/data/MSCMR_v5/train_volumes_p4.list')
        fold5_testing_set = read_txt('/mnt/sdd/tb/data/MSCMR_v5/train_volumes_p5.list')
